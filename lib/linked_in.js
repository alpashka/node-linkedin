var OAuth2 = require('./oauth2').OAuth2,
  URL = require('url'),
  qs = require('qs'),
  baseUrl = process.env.LINKEDINAPI || 'http://api.linkedin.com/';


exports.LinkedIn = function(key, secret) {
  this.baseUrl = baseUrl;
  this.OAuth2 = new OAuth2(key, secret);
}

exports.LinkedIn.prototype._secureRequest = function(method, path, data, callback) {
...
exports.LinkedIn.prototype.get = function(path, data, callback) {
  return this._secureRequest('GET', path, data, callback)
}
exports.LinkedIn.prototype.post = function(path, data, callback) {
  return this._secureRequest('POST', path, data, callback)
}
exports.LinkedIn.prototype.put = function(path, data, callback) {
  return this._secureRequest('PUT', path, data, callback)
}
exports.LinkedIn.prototype.delete = function(path, data, callback) {
